...
public class Calculadora extends JFrame {
	...
	public Calculadora() {
		...
		panelOperaciones.setBorder(new EmptyBorder(7, 7, 7,7 ));
	...
	private void calcularResultado() {
		if (operacion.equals("+")) {
			...
			resultado = new Double(Math.pow(Double.parseDouble(pantalla.getText()), 2));
		}else if (operacion.equals("^3")) {
			resultado = new Double(Math.pow(Double.parseDouble(pantalla.getText()), 3));
		}else if (operacion.equals("!")) {
			for(int i= Integer.parseInt(pantalla.getText()); i>1 ;i--){
                            if (resultado == 0){
